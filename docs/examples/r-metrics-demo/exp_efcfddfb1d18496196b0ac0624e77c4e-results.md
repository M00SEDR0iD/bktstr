# Test results: exp_efcfddfb1d18496196b0ac0624e77c4e
...
| Daily Sharpe (annualized) | -32.0252 |
| Maximum drawdown (%) | 0.71386 |
| Maximum drawdown ($) | 71.386 |

Trades: 7. Scored sessions: 3.
...
Specification: policy-volume at 1.0.0
...
| Ending equity | 9928.61 |
| Expected pnl per trade | -10.198 |
| Losses | 7 |
| Max drawdown pct | -0.71386 |
| Total pnl dollars | -71.386 |
| Trades | 7 |
| Win rate pct | 0 |
| Wins | 0 |
...
```json
{
  ...
  "specification": {
    "digest": "f80139e39417c48372e8795c788e51872130e82169866b26dfd281fefca2a8dd",
    "id": "policy-volume",
    "version": "1.0.0"
  },
